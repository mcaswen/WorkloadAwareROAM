...
- 详细 CSV：`runtime-benchmark-20260823-203357.csv`
...
- Benchmark 标签：command-line-refactor-final-default
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 7.84 | 41.82 | 7.47 | 41.11 | 10699.66 | 12629 | 37578.82 | 49326 | 103.08 | 625.20 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 6.53 | 28.89 | 6.22 | 27.97 | 10699.66 | 12629 | 37578.82 | 49326 | 131.12 | 2772.54 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1645 | 0.3208 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.4705 | 0.1946 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0384 | 0.0677 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 0.6110 | 0.3089 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 0.0858 | 0.1046 | 按同一预算与 forced-split 约束提交 |
...
| Finalize / 发布 packet | 0.8386 | 0.9266 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 2.2518 | 0.1645 | 0.4705 | 0.0384 | 0.0000 | 0.0000 | 0.6110 | 0.0858 | 0.0000 | 0.0424 | 0.8386 | 0.0265 |
| Data-Oriented CPU ROAM | 2.0001 | 0.3208 | 0.1946 | 0.0677 | 0.0000 | 0.0000 | 0.3089 | 0.1046 | 0.0000 | 0.0767 | 0.9266 | 0.0234 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 2122.9550 | 0.9983 | 0.4652 | 0.0053 | 0.4705 | 247.6117 | 0.0204 | 0.0000 |
| Classic CPU ROAM | Q_s | 10685.4250 | 1.0000 | 0.5420 | 0.0689 | 0.6110 | 203.9183 | 0.0189 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 2122.9550 | 7.9867 | 0.1859 | 0.0087 | 0.1946 | 247.6117 | 0.0277 | 0.0035 |
| Data-Oriented CPU ROAM | Q_s | 10658.5567 | 7.9883 | 0.2562 | 0.0527 | 0.3089 | 203.9150 | 0.0250 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0858 | 0.0858 | 0.0858 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.1004 | 0.1004 | 0.1046 |
| Merge | 0.0038 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0554 | 0.0592 | 0.0677 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.6968 | 0.5089 | 0.0424 | 0.0000 |
| Data-Oriented CPU ROAM | 0.4135 | 0.2622 | 0.0767 | 0.0000 |
