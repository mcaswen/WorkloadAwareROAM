...
- 详细 CSV：`runtime-benchmark-20260823-175252.csv`

- 构建配置：RelWithDebInfo
- 图形后端：OpenGL
- 图形适配器：NVIDIA GeForce RTX 5090 D/PCIe/SSE2 (4.1.0 NVIDIA 591.86)
- 阶段策略：默认自动策略
- Benchmark 标签：phase2-budget-saturation
- Benchmark 路径：极限压力路径
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 425.90 | 982.69 | 422.06 | 967.88 | 200000.00 | 200000 | 1127313.41 | 1618212 | 99.65 | 107.12 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 275.41 | 1197.54 | 247.08 | 622.74 | 199999.44 | 200000 | 1127303.84 | 1618198 | 141.65 | 243.16 | 8 | 20 | 20 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 10.0846 | 9.6714 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 15.9523 | 3.0146 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 25.2806 | 26.8302 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 46.7924 | 7.5930 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 48.8754 | 42.2026 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 30.1347 | 10.4360 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 55.2733 | 29.9931 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 232.3949 | 10.0846 | 15.9523 | 25.2806 | 0.0000 | 0.0000 | 46.7924 | 48.8754 | 0.0000 | 30.1347 | 55.2733 | 7.6694 |
| Data-Oriented CPU ROAM | 129.7414 | 9.6714 | 3.0146 | 26.8302 | 0.0000 | 0.0000 | 7.5930 | 42.2026 | 0.0000 | 10.4360 | 29.9931 | 9.2993 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 33158.7031 | 0.9844 | 15.6740 | 0.2783 | 15.9523 | 100627.8750 | 10.3860 | 0.0000 |
| Classic CPU ROAM | Q_s | 196875.0312 | 1.0000 | 44.9731 | 1.8193 | 46.7924 | 102656.2812 | 11.8514 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 33158.2812 | 7.8750 | 2.6548 | 0.3598 | 3.0146 | 102192.3125 | 11.3157 | 0.0373 |
| Data-Oriented CPU ROAM | Q_s | 191668.1875 | 7.8906 | 6.1566 | 1.4364 | 7.5930 | 102655.1719 | 14.6892 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 48.8754 | 48.8754 | 48.8754 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 42.1976 | 42.1976 | 42.2026 |
| Merge | 0.2180 | 1.1953 | 0.4542 | 0.0110 | 4.8846 | 20.0061 | 26.7693 | 26.8302 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 95.6678 | 41.2329 | 30.1347 | 0.0000 |
| Data-Oriented CPU ROAM | 65.9455 | 29.8448 | 10.4360 | 0.0000 |
