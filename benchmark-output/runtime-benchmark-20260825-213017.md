...
- 详细 CSV：`runtime-benchmark-20260825-213017.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 7.23 | 41.84 | 6.97 | 41.21 | 10699.66 | 12629 | 37578.82 | 49326 | 88.48 | 458.53 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 6.05 | 36.08 | 5.75 | 35.43 | 10699.66 | 12629 | 37578.82 | 49326 | 118.19 | 3320.07 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1148 | 0.1460 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.4787 | 0.1452 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0372 | 0.0550 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 0.5262 | 0.2514 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 0.0922 | 0.1020 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 0.0386 | 0.0592 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 0.6862 | 0.6372 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 1.9745 | 0.1148 | 0.4787 | 0.0372 | 0.0000 | 0.0000 | 0.5262 | 0.0922 | 0.0000 | 0.0386 | 0.6862 | 0.0242 |
| Data-Oriented CPU ROAM | 1.3961 | 0.1460 | 0.1452 | 0.0550 | 0.0000 | 0.0000 | 0.2514 | 0.1020 | 0.0000 | 0.0592 | 0.6372 | 0.0238 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 2122.9550 | 0.9983 | 0.4731 | 0.0056 | 0.4787 | 247.6117 | 0.0217 | 0.0000 |
| Classic CPU ROAM | Q_s | 10685.4250 | 1.0000 | 0.4675 | 0.0587 | 0.5262 | 203.9183 | 0.0180 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 2122.9550 | 7.9867 | 0.1389 | 0.0063 | 0.1452 | 247.6117 | 0.0268 | 0.0027 |
| Data-Oriented CPU ROAM | Q_s | 10658.5567 | 7.9883 | 0.2102 | 0.0412 | 0.2514 | 203.9150 | 0.0199 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0922 | 0.0922 | 0.0922 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0993 | 0.0993 | 0.1020 |
| Merge | 0.0030 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0445 | 0.0474 | 0.0550 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.6184 | 0.5159 | 0.0386 | 0.0000 |
| Data-Oriented CPU ROAM | 0.3534 | 0.2002 | 0.0592 | 0.0000 |
