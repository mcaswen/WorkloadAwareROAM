...
- 详细 CSV：`runtime-benchmark-20260823-200327.csv`
...
- Benchmark 标签：experiment-infra-final-budget-saturation
- 算法顺序：Data-Oriented CPU ROAM -> Classic CPU ROAM；轮换偏移 1
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Data-Oriented CPU ROAM | 64 | 335.92 | 835.13 | 312.97 | 828.08 | 199999.44 | 200000 | 1127303.84 | 1618198 | 126.16 | 208.73 | 8 | 20 | 20 | 0 |
| Classic CPU ROAM | 64 | 546.74 | 1406.69 | 521.56 | 1217.93 | 200000.00 | 200000 | 1127313.41 | 1618212 | 99.25 | 104.76 | 1 | 20 | 20 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 12.0981 | 11.5312 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 18.9479 | 3.0269 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 33.5699 | 33.5376 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 54.7773 | 7.5686 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 62.8885 | 53.1232 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 38.6936 | 12.2424 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 72.0883 | 43.2625 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Data-Oriented CPU ROAM | 164.2930 | 11.5312 | 3.0269 | 33.5376 | 0.0000 | 0.0000 | 7.5686 | 53.1232 | 0.0000 | 12.2424 | 43.2625 | 9.3877 |
| Classic CPU ROAM | 293.0658 | 12.0981 | 18.9479 | 33.5699 | 0.0000 | 0.0000 | 54.7773 | 62.8885 | 0.0000 | 38.6936 | 72.0883 | 7.5883 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Data-Oriented CPU ROAM | Q_m | 33158.2812 | 7.8750 | 2.6836 | 0.3433 | 3.0269 | 102192.3125 | 13.7876 | 0.0318 |
| Data-Oriented CPU ROAM | Q_s | 191668.1875 | 7.8906 | 6.2302 | 1.3384 | 7.5686 | 102655.1719 | 18.3351 | 0.0000 |
| Classic CPU ROAM | Q_m | 33158.7031 | 0.9844 | 18.5140 | 0.4339 | 18.9479 | 100627.8750 | 12.2912 | 0.0000 |
| Classic CPU ROAM | Q_s | 196875.0312 | 1.0000 | 52.3842 | 2.3931 | 54.7773 | 102656.2812 | 17.2548 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 62.8885 | 62.8885 | 62.8885 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 53.1175 | 53.1175 | 53.1232 |
| Merge | 0.2480 | 1.2909 | 0.3460 | 0.0074 | 5.4759 | 26.1139 | 33.4822 | 33.5376 |
...
| --- | ---: | ---: | ---: | ---: |
| Data-Oriented CPU ROAM | 81.6335 | 36.5645 | 12.2424 | 0.0000 |
| Classic CPU ROAM | 117.6658 | 52.5178 | 38.6936 | 0.0000 |
