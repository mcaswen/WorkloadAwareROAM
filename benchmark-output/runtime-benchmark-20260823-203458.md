...
- 详细 CSV：`runtime-benchmark-20260823-203458.csv`
...
- Benchmark 标签：command-line-refactor-final-stress
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 408.63 | 1003.56 | 389.79 | 823.57 | 200000.00 | 200000 | 1127313.41 | 1618212 | 99.49 | 107.50 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 271.02 | 616.46 | 252.34 | 609.58 | 199999.44 | 200000 | 1127303.84 | 1618198 | 138.06 | 252.28 | 8 | 20 | 20 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 9.7224 | 9.8372 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 13.9306 | 3.1843 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 22.3915 | 26.8561 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 45.2538 | 7.8962 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 43.3219 | 42.0507 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 26.7498 | 10.7364 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 53.9226 | 31.8976 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 215.2941 | 9.7224 | 13.9306 | 22.3915 | 0.0000 | 0.0000 | 45.2538 | 43.3219 | 0.0000 | 26.7498 | 53.9226 | 7.9706 |
| Data-Oriented CPU ROAM | 132.4591 | 9.8372 | 3.1843 | 26.8561 | 0.0000 | 0.0000 | 7.8962 | 42.0507 | 0.0000 | 10.7364 | 31.8976 | 10.0555 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 33158.7031 | 0.9844 | 13.6973 | 0.2333 | 13.9306 | 100627.8750 | 9.2422 | 0.0000 |
| Classic CPU ROAM | Q_s | 196875.0312 | 1.0000 | 43.7707 | 1.4831 | 45.2538 | 102656.2812 | 10.7266 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 33158.2812 | 7.8750 | 2.8279 | 0.3564 | 3.1843 | 102192.3125 | 10.9921 | 0.0328 |
| Data-Oriented CPU ROAM | Q_s | 191668.1875 | 7.8906 | 6.5047 | 1.3915 | 7.8962 | 102655.1719 | 14.5172 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 43.3219 | 43.3219 | 43.3219 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 42.0460 | 42.0460 | 42.0507 |
| Merge | 0.2392 | 1.2562 | 0.4310 | 0.0122 | 4.9930 | 19.8715 | 26.8032 | 26.8561 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 88.5757 | 36.3221 | 26.7498 | 0.0000 |
| Data-Oriented CPU ROAM | 65.7978 | 30.0404 | 10.7364 | 0.0000 |
