...
- 详细 CSV：`runtime-benchmark-20260822-224302.csv`
...
- 阶段策略：最大安全并行 + 全量输出
- Benchmark 标签：phase1-d3d12-maximum-parallel-full-output
- Benchmark 路径：默认选项路径
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 4 | 24.96 | 48.39 | 25.71 | 37.17 | 10660.25 | 12591 | 35647.50 | 45676 | 111.09 | 175.49 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 4 | 26.34 | 38.73 | 19.81 | 24.06 | 10660.25 | 12591 | 35647.50 | 45676 | 125.69 | 262.37 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.4733 | 0.4928 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.2986 | 0.2469 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 2.4298 | 4.2122 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 0.4759 | 0.1522 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 7.8675 | 6.7724 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 7.0272 | 2.9182 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 1.2316 | 0.7637 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 19.8045 | 0.4733 | 0.2986 | 2.4298 | 0.0000 | 0.0000 | 0.4759 | 7.8675 | 0.0000 | 7.0272 | 1.2316 | 0.7730 |
| Data-Oriented CPU ROAM | 15.5586 | 0.4928 | 0.2469 | 4.2122 | 0.0000 | 0.0000 | 0.1522 | 6.7724 | 0.0000 | 2.9182 | 0.7637 | 0.0869 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 7.8675 | 7.8675 | 7.8675 |
| DoD Split | 0.1745 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 6.5963 | 6.7708 | 6.7724 |
| Merge | 0.0776 | 0.5638 | 0.1373 | 0.0058 | 2.0787 | 1.3270 | 4.1901 | 4.2122 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 8.3434 | 2.7284 | 7.0272 | 0.0000 |
| Data-Oriented CPU ROAM | 6.9246 | 4.4591 | 2.9182 | 0.0000 |
