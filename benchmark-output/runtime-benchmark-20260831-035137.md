...
- 详细 CSV：`runtime-benchmark-20260831-035137.csv`
...
- Benchmark 标签：phase5-default-final
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 7.36 | 38.37 | 7.10 | 37.73 | 10699.66 | 12629 | 37578.82 | 49326 | 98.33 | 582.14 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 5.73 | 24.88 | 5.48 | 24.34 | 10699.66 | 12629 | 37578.82 | 49326 | 122.37 | 2049.14 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1076 | 0.1416 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.4437 | 0.1954 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0337 | 0.0566 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 0.5516 | 0.2914 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 0.0821 | 0.0870 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 0.0389 | 0.0572 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 0.7653 | 0.5852 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 2.0233 | 0.1076 | 0.4437 | 0.0337 | 0.0000 | 0.0000 | 0.5516 | 0.0821 | 0.0000 | 0.0389 | 0.7653 | 0.0214 |
| Data-Oriented CPU ROAM | 1.4146 | 0.1416 | 0.1954 | 0.0566 | 0.0000 | 0.0000 | 0.2914 | 0.0870 | 0.0000 | 0.0572 | 0.5852 | 0.0205 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 2122.9550 | 0.9983 | 0.4389 | 0.0047 | 0.4437 | 247.6117 | 0.0189 | 0.0000 |
| Classic CPU ROAM | Q_s | 10685.4250 | 1.0000 | 0.4761 | 0.0755 | 0.5516 | 203.9183 | 0.0160 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 2122.9550 | 7.9867 | 0.1878 | 0.0077 | 0.1954 | 247.6117 | 0.0278 | 0.0030 |
| Data-Oriented CPU ROAM | Q_s | 10658.5567 | 7.9883 | 0.2379 | 0.0535 | 0.2914 | 203.9150 | 0.0200 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0821 | 0.0821 | 0.0821 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0839 | 0.0839 | 0.0870 |
| Merge | 0.0025 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0466 | 0.0490 | 0.0566 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.6337 | 0.4774 | 0.0389 | 0.0000 |
| Data-Oriented CPU ROAM | 0.3784 | 0.2520 | 0.0572 | 0.0000 |
