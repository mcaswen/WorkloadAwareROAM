...
- 详细 CSV：`runtime-benchmark-20260822-224103.csv`

- 构建配置：RelWithDebInfo
- 图形后端：OpenGL
- 图形适配器：NVIDIA GeForce RTX 5090 D/PCIe/SSE2 (4.1.0 NVIDIA 591.86)
- 阶段策略：默认自动策略
- Benchmark 标签：phase1-four-presets-default-acceptance
- Benchmark 路径：默认选项路径
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 6.32 | 33.58 | 6.08 | 30.52 | 10699.66 | 12629 | 37578.82 | 49326 | 100.92 | 660.75 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 5.41 | 85.60 | 4.92 | 21.57 | 10699.66 | 12629 | 37578.82 | 49326 | 121.71 | 2619.79 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.0913 | 0.0907 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.4027 | 0.1626 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0260 | 0.0373 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 0.4472 | 0.2406 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 0.0639 | 0.0612 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 0.0324 | 0.0409 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 0.5431 | 0.4809 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 1.6068 | 0.0913 | 0.4027 | 0.0260 | 0.0000 | 0.0000 | 0.4472 | 0.0639 | 0.0000 | 0.0324 | 0.5431 | 0.0224 |
| Data-Oriented CPU ROAM | 1.1144 | 0.0907 | 0.1626 | 0.0373 | 0.0000 | 0.0000 | 0.2406 | 0.0612 | 0.0000 | 0.0409 | 0.4809 | 0.0193 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0639 | 0.0639 | 0.0639 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0611 | 0.0611 | 0.0612 |
| Merge | 0.0045 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0315 | 0.0360 | 0.0373 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.5111 | 0.4287 | 0.0324 | 0.0000 |
| Data-Oriented CPU ROAM | 0.3019 | 0.1999 | 0.0409 | 0.0000 |
