...
- 详细 CSV：`runtime-benchmark-20260822-215537.csv`

- 构建配置：RelWithDebInfo
- 图形后端：OpenGL
- 图形适配器：NVIDIA GeForce RTX 5090 D/PCIe/SSE2 (4.1.0 NVIDIA 591.86)
- 阶段策略：最大安全并行策略
- Benchmark 标签：phase1-parallel-dirty-upload
- Benchmark 路径：默认选项路径
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 4 | 20.33 | 36.40 | 22.67 | 33.86 | 10660.25 | 12591 | 35647.50 | 45676 | 104.83 | 134.47 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 4 | 46.39 | 103.71 | 19.64 | 23.52 | 10660.25 | 12591 | 35647.50 | 45676 | 93.65 | 165.92 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.5583 | 0.6852 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.3381 | 0.3343 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 2.4687 | 4.4039 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 0.5378 | 0.1588 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 8.0770 | 7.4378 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 4.6440 | 1.4268 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 0.9934 | 0.8565 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 17.6179 | 0.5583 | 0.3381 | 2.4687 | 0.0000 | 0.0000 | 0.5378 | 8.0770 | 0.0000 | 4.6440 | 0.9934 | 0.2067 |
| Data-Oriented CPU ROAM | 15.3036 | 0.6852 | 0.3343 | 4.4039 | 0.0000 | 0.0000 | 0.1588 | 7.4378 | 0.0000 | 1.4268 | 0.8565 | 0.2158 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 8.0770 | 8.0770 | 8.0770 |
| DoD Split | 0.2038 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 7.2327 | 7.4365 | 7.4378 |
| Merge | 0.1340 | 0.5738 | 0.1037 | 0.0033 | 2.1830 | 1.3979 | 4.3958 | 4.4039 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 8.6148 | 2.8068 | 4.6440 | 0.0000 |
| Data-Oriented CPU ROAM | 7.5966 | 4.7382 | 1.4268 | 0.0000 |
