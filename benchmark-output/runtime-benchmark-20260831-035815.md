...
- 详细 CSV：`runtime-benchmark-20260831-035815.csv`
- CPU 上传配对 CSV：`runtime-benchmark-20260831-035815-cpu-upload.csv`
...
- Benchmark 标签：phase5-upload-opengl-final
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 4 | 22.43 | 39.70 | 25.64 | 37.34 | 10660.25 | 12591 | 35647.50 | 45676 | 76.98 | 88.60 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 4 | 44.97 | 92.50 | 20.14 | 24.74 | 10660.25 | 12591 | 35647.50 | 45676 | 524.77 | 917.57 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.4862 | 0.5075 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.3458 | 0.1508 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 3.0504 | 4.5276 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 0.4935 | 0.1602 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 9.5887 | 8.1871 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 4.7566 | 1.3792 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 1.1392 | 0.8174 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 19.8610 | 0.4862 | 0.3458 | 3.0504 | 0.0000 | 0.0000 | 0.4935 | 9.5887 | 0.0000 | 4.7566 | 1.1392 | 0.2084 |
| Data-Oriented CPU ROAM | 15.7300 | 0.5075 | 0.1508 | 4.5276 | 0.0000 | 0.0000 | 0.1602 | 8.1871 | 0.0000 | 1.3792 | 0.8174 | 0.2021 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 1672.0000 | 0.7500 | 0.3265 | 0.0193 | 0.3458 | 33219.2500 | 2.0864 | 0.0000 |
| Classic CPU ROAM | Q_s | 8525.0000 | 1.0000 | 0.4158 | 0.0777 | 0.4935 | 27937.2500 | 2.1108 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 1672.0000 | 6.0000 | 0.1323 | 0.0184 | 0.1508 | 31635.2500 | 1.9407 | 0.0054 |
| Data-Oriented CPU ROAM | Q_s | 4936.5000 | 6.2500 | 0.1320 | 0.0282 | 0.1602 | 27936.7500 | 2.0617 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 9.5887 | 9.5887 | 9.5887 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 8.1849 | 8.1849 | 8.1871 |
| Merge | 0.0752 | 0.5257 | 0.1231 | 0.0051 | 2.1612 | 1.5740 | 4.4643 | 4.5276 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 10.0821 | 3.3963 | 4.7566 | 0.0000 |
| Data-Oriented CPU ROAM | 8.3473 | 4.6784 | 1.3792 | 0.0000 |
