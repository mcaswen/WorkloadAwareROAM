...
- 详细 CSV：`runtime-benchmark-20260829-015743.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 8.12 | 40.60 | 7.73 | 39.91 | 10699.66 | 12629 | 37578.82 | 49326 | 100.33 | 564.73 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 7.21 | 42.63 | 6.63 | 35.49 | 10699.66 | 12629 | 37578.82 | 49326 | 139.89 | 2973.36 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.1721 | 0.2183 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.4994 | 0.2300 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 0.0456 | 0.0751 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 0.6119 | 0.3621 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 0.0977 | 0.1208 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 0.0467 | 0.0780 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 0.9219 | 0.9079 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 2.3959 | 0.1721 | 0.4994 | 0.0456 | 0.0000 | 0.0000 | 0.6119 | 0.0977 | 0.0000 | 0.0467 | 0.9219 | 0.0294 |
| Data-Oriented CPU ROAM | 1.9926 | 0.2183 | 0.2300 | 0.0751 | 0.0000 | 0.0000 | 0.3621 | 0.1208 | 0.0000 | 0.0780 | 0.9079 | 0.0318 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 2122.9550 | 0.9983 | 0.4934 | 0.0060 | 0.4994 | 247.6117 | 0.0217 | 0.0000 |
| Classic CPU ROAM | Q_s | 10685.4250 | 1.0000 | 0.5441 | 0.0678 | 0.6119 | 203.9183 | 0.0186 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 2122.9550 | 7.9867 | 0.2205 | 0.0096 | 0.2300 | 247.6117 | 0.0311 | 0.0033 |
| Data-Oriented CPU ROAM | Q_s | 10658.5567 | 7.9883 | 0.3120 | 0.0502 | 0.3621 | 203.9150 | 0.0275 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0977 | 0.0977 | 0.0977 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.1167 | 0.1167 | 0.1208 |
| Merge | 0.0044 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0609 | 0.0653 | 0.0751 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.7096 | 0.5450 | 0.0467 | 0.0000 |
| Data-Oriented CPU ROAM | 0.4829 | 0.3051 | 0.0780 | 0.0000 |
