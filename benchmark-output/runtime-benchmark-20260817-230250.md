...
- 详细 CSV：`runtime-benchmark-20260817-230250.csv`

- 构建配置：RelWithDebInfo
- 图形后端：OpenGL
- 图形适配器：NVIDIA GeForce RTX 5090 D/PCIe/SSE2 (4.3.0 NVIDIA 591.86)
- Benchmark 标签：C1-final
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 600 | 1.76 | 28.77 | 1.59 | 26.09 | 10699.66 | 12629 | 37578.82 | 49326 | 93.44 | 2771.86 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 600 | 2.36 | 95.34 | 1.88 | 17.77 | 10699.66 | 12629 | 37578.82 | 49326 | 292.08 | 10530.75 | 8 | 14 | 14 | 0 |
| GPU ROAM-like | 600 | 4.18 | 22.04 | 3.82 | 21.50 | 10699.66 | 12629 | 37578.82 | 49326 | 135.16 | 4163.75 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | ---: | ---: | --- |
| Prepare / 帧状态 | 0.0839 | 0.0887 | 0.1602 | N/A | CPU 准备持久拓扑和 snapshot 输入 |
| Merge 候选评分 | 0.4009 | 0.1112 | 0.2004 | 0.0051 | Shader 为诊断重新扫描已 split 的父节点；GPU 不提交这些候选 |
| Merge 拓扑提交 / 向上级联 | 0.0223 | 0.0392 | 0.0519 | N/A | 持久 merge、邻接修复和级联回收由 Classic/DOD CPU 路径执行；GPU shader 未提交 merge |
...
| Split 扫描/标记 | 0.4313 | 0.1836 | 0.4322 | 0.0037 | DOD CPU 数值包含持久 Q_s 的并行 SSE/视锥优先级刷新、原地建堆和提交快照生成；GPU append 顺序不是误差优先级顺序 |
| Split 拓扑 / 裂缝约束提交 | 0.0616 | 0.0689 | 0.0816 | 0.0030 | GPU 只提交一轮受预算约束的细分，并只处理直接 base-neighbor diamond pair；没有递归 forced-split 链 |
...
| Mesh emit / draw argument 生成 | 0.0355 | 0.6630 | 0.0000 | 0.0100 | Classic 只重写拓扑变化影响的稳定槽位；DOD 仍完整 emit；GPU 输出非共享顶点、索引和 indirect draw argument |
| Finalize / 发布 packet | 0.5299 | 0.4714 | 0.7056 | N/A | CPU 发布统计和 renderer 资源契约 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 1.5656 | 0.0839 | 0.4009 | 0.0223 | 0.0000 | 0.0000 | 0.4313 | 0.0616 | 0.0000 | 0.0355 | 0.5299 | 0.0224 |
| Data-Oriented CPU ROAM | 1.6262 | 0.0887 | 0.1112 | 0.0392 | 0.0000 | 0.0000 | 0.1836 | 0.0689 | 0.0000 | 0.6630 | 0.4714 | 0.2089 |
| GPU ROAM-like | 1.6320 | 0.1602 | 0.2004 | 0.0519 | 0.0000 | 0.0000 | 0.4322 | 0.0816 | 0.0000 | 0.0000 | 0.7056 | 0.5667 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 0.0616 | 0.0616 | 0.0616 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0687 | 0.0687 | 0.0689 |
| Merge | 0.0024 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0355 | 0.0379 | 0.0392 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 0.4929 | 0.4232 | 0.0355 | 0.0000 |
| Data-Oriented CPU ROAM | 0.2525 | 0.1504 | 0.6630 | 0.0000 |
| GPU ROAM-like | 0.5137 | 0.2523 | 0.0000 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| GPU ROAM-like | 0.0042 | 0.0046 | 0.0037 | 0.0051 | 0.0030 | 0.0027 | 0.0039 | 0.0100 | 0.0371 | 0.0529 |
...
| GPU ROAM-like | 1.03 | 0.10 | 0.04 | 0.00 | 0.31 | 0.00 | 0.00 | 0.00 | 5524564 | 96 |
