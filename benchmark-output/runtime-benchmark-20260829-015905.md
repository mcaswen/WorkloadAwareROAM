...
- 详细 CSV：`runtime-benchmark-20260829-015905.csv`
...
- Benchmark 标签：phase4-budget-saturation
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 634.20 | 1240.83 | 611.22 | 1120.71 | 200000.00 | 200000 | 1127313.41 | 1618212 | 99.36 | 121.92 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 332.32 | 655.39 | 311.75 | 649.35 | 199999.44 | 200000 | 1127303.84 | 1618198 | 127.26 | 198.43 | 8 | 20 | 20 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 14.1558 | 12.6080 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 20.9374 | 3.3890 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 38.9945 | 33.8983 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/评分 | 63.4565 | 9.2723 | 刷新 Q_s 分数并原地建堆 |
| Split 拓扑 / 裂缝约束提交 | 69.2933 | 52.4942 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 41.9079 | 12.1861 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 90.8641 | 43.5389 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 339.6122 | 14.1558 | 20.9374 | 38.9945 | 0.0000 | 0.0000 | 63.4565 | 69.2933 | 0.0000 | 41.9079 | 90.8641 | 9.3789 |
| Data-Oriented CPU ROAM | 167.3875 | 12.6080 | 3.3890 | 33.8983 | 0.0000 | 0.0000 | 9.2723 | 52.4942 | 0.0000 | 12.1861 | 43.5389 | 11.3354 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | Q_m | 33158.7031 | 0.9844 | 20.3963 | 0.5411 | 20.9374 | 100627.8750 | 13.9537 | 0.0000 |
| Classic CPU ROAM | Q_s | 196875.0312 | 1.0000 | 60.3960 | 3.0604 | 63.4565 | 102656.2812 | 19.7512 | 0.0000 |
| Data-Oriented CPU ROAM | Q_m | 33158.2812 | 7.8750 | 2.9986 | 0.3905 | 3.3890 | 102192.3125 | 13.6148 | 0.0289 |
| Data-Oriented CPU ROAM | Q_s | 191668.1875 | 7.8906 | 7.4528 | 1.8194 | 9.2723 | 102655.1719 | 18.1960 | 0.0000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 69.2933 | 69.2933 | 69.2933 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 52.4851 | 52.4851 | 52.4942 |
| Merge | 0.2581 | 1.2737 | 0.5013 | 0.0117 | 5.4185 | 26.3349 | 33.7983 | 33.8983 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 132.7498 | 59.9319 | 41.9079 | 0.0000 |
| Data-Oriented CPU ROAM | 83.1278 | 37.2873 | 12.1861 | 0.0000 |
