...
- 详细 CSV：`runtime-benchmark-20260822-223939.csv`

- 构建配置：RelWithDebInfo
- 图形后端：OpenGL
- 图形适配器：NVIDIA GeForce RTX 5090 D/PCIe/SSE2 (4.1.0 NVIDIA 591.86)
- 阶段策略：最大安全并行 + 全量输出
- Benchmark 标签：phase1-maximum-parallel-full-output
- Benchmark 路径：默认选项路径
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 4 | 22.57 | 40.37 | 24.77 | 36.82 | 10660.25 | 12591 | 35647.50 | 45676 | 106.66 | 129.61 | 1 | 14 | 14 | 0 |
| Data-Oriented CPU ROAM | 4 | 43.19 | 87.42 | 20.59 | 23.81 | 10660.25 | 12591 | 35647.50 | 45676 | 132.36 | 153.22 | 8 | 14 | 14 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 0.5417 | 0.5393 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 0.3113 | 0.2580 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 2.4604 | 4.4336 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 0.4796 | 0.1523 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 8.0404 | 7.0649 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 6.5612 | 3.1276 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 1.2080 | 0.7780 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 19.6032 | 0.5417 | 0.3113 | 2.4604 | 0.0000 | 0.0000 | 0.4796 | 8.0404 | 0.0000 | 6.5612 | 1.2080 | 0.1994 |
| Data-Oriented CPU ROAM | 16.3541 | 0.5393 | 0.2580 | 4.4336 | 0.0000 | 0.0000 | 0.1523 | 7.0649 | 0.0000 | 3.1276 | 0.7780 | 0.2072 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 8.0404 | 8.0404 | 8.0404 |
| DoD Split | 0.1618 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 6.9016 | 7.0635 | 7.0649 |
| Merge | 0.1103 | 0.5533 | 0.1125 | 0.0036 | 2.2524 | 1.3770 | 4.4091 | 4.4336 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 8.5200 | 2.7717 | 6.5612 | 0.0000 |
| Data-Oriented CPU ROAM | 7.2172 | 4.6916 | 3.1276 | 0.0000 |
