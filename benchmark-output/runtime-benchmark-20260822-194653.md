...
- 详细 CSV：`runtime-benchmark-20260822-194653.csv`

- 构建配置：RelWithDebInfo
- 图形后端：OpenGL
- 图形适配器：NVIDIA GeForce RTX 5090 D/PCIe/SSE2 (4.1.0 NVIDIA 591.86)
- Benchmark 标签：phase0-stress-acceptance
- Benchmark 路径：极限压力路径
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 64 | 319.83 | 839.58 | 313.66 | 827.50 | 200000.00 | 200000 | 1127313.41 | 1618212 | 99.13 | 110.16 | 1 | 20 | 20 | 0 |
| Data-Oriented CPU ROAM | 64 | 201.05 | 880.68 | 176.73 | 471.68 | 199999.44 | 200000 | 1127303.84 | 1618198 | 157.24 | 306.99 | 8 | 20 | 20 | 0 |
...
| --- | ---: | ---: | --- |
| Prepare / 帧状态 | 9.0252 | 8.1268 | 准备持久拓扑和逐帧输入 |
| Merge 候选评分 | 13.2790 | 3.0222 | 刷新持久 Q_m 的优先级 |
| Merge 拓扑提交 / 向上级联 | 18.1422 | 20.7116 | 提交 diamond merge、邻接修复和级联回收 |
| Split 前 active leaf 收集 | 0.0000 | 0.0000 | 两者均直接复用持久活动叶表示 |
| 视点相关 leaf error / 视锥测试 | 0.0000 | 0.0000 | 计入持久 Q_s 优先级刷新，因此独立字段为 0 |
| Split 扫描/标记 | 42.8319 | 7.1451 | 刷新 Q_s、建堆并生成提交候选 |
| Split 拓扑 / 裂缝约束提交 | 37.9577 | 33.3219 | 按同一预算与 forced-split 约束提交 |
| 细分后 active leaf 收集 / 输出视图 | 0.0000 | 0.0000 | Classic 复用 dense slot owners，DOD 复用 ActiveLeafNodes |
| Mesh emit / draw argument 生成 | 25.4089 | 9.9163 | 两者均只重写 dirty slot；DOD 可将较大批次分段给 worker |
| Finalize / 发布 packet | 46.4601 | 25.5828 | 汇总统计、更新跨帧状态并发布 renderer packet |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 193.1061 | 9.0252 | 13.2790 | 18.1422 | 0.0000 | 0.0000 | 42.8319 | 37.9577 | 0.0000 | 25.4089 | 46.4601 | 6.9582 |
| Data-Oriented CPU ROAM | 107.8270 | 8.1268 | 3.0222 | 20.7116 | 0.0000 | 0.0000 | 7.1451 | 33.3219 | 0.0000 | 9.9163 | 25.5828 | 8.7334 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Classic Split | 0 | 0 | 0 | 0 | 0 | 37.9577 | 37.9577 | 37.9577 |
| DoD Split | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 33.3214 | 33.3214 | 33.3219 |
| Merge | 0.2081 | 1.0250 | 0.4186 | 0.0089 | 4.1575 | 14.8740 | 20.6921 | 20.7116 |
...
| --- | ---: | ---: | ---: | ---: |
| Classic CPU ROAM | 80.7896 | 31.4212 | 25.4089 | 0.0000 |
| Data-Oriented CPU ROAM | 52.4788 | 23.7338 | 9.9163 | 0.0000 |
